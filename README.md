...
本仓库用于分析机械性窒息组（Asphyxia）与对照组（CON）小鼠额叶的转录组、蛋白组和代谢组数据。额叶在原始数据中编号为 R1。

## 实验设计

| 组学 | Asphyxia | CON | 分析范围 |
|---|---:|---:|---|
| 转录组 | 3 | 3 | 额叶（R1） |
| 蛋白组 | 4 | 4 | 额叶（R1） |
| 代谢组 | 6 | 6 | 额叶（R1）；另有 3 个 QC 样本 |

同一实验组内编号相同的样本来自同一只动物。转录组样本名中的 `CON_R1_1`、`Asphyxia_R1_1` 分别对应统一动物编号 `CON-1`、`Asphyxia-1`，其余编号以此类推。

- 三组学完整配对：每组 3 只动物，即 CON-1～3 和 Asphyxia-1～3。
- 蛋白组与代谢组配对：每组 4 只动物，即 CON-1～4 和 Asphyxia-1～4。
- 代谢组另有每组 2 只动物，即 CON-5～6 和 Asphyxia-5～6。
